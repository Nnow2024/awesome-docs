...
数据来源：[终端计算产品页](https://www.axera-tech.com/zh-hans/product/vision)、[边缘计算产品页](https://www.axera-tech.com/zh-hans/product/edge-aI-inference)。硬参数以官方 datasheet 为准，未公开的标注"待补充"。
...
下表列出各产品线的典型应用方向，具体方案详见[行业解决方案](../06_solutions/index.md)章节。

| 场景 | 涉及产品线 | 代表芯片 | 说明 |
| --- | --- | --- | --- |
| 智慧安防 | 终端计算 | AX650A、AX630C | AI NVR、AIBOX、智能相机 |
| 大语言模型推理 | 边缘计算 | AX8850、AX8850N | 端侧 LLM/VLM 推理 |
| 智能语音 | 终端/边缘 | AX650N、AX8850 | ASR、TTS、降噪 |
| 工业视觉 | 终端计算 | AX650A、XS7320 | 检测、分割、关键点、双目深度 |
| 轻智能终端 | 终端计算 | AX520CD、AX513CE | 低功耗智能感知终端 |

```{note}
场景雷达图待补充，目前以上表形式呈现各场景与芯片的对应关系。
```
