...
本页包含系统相关和 NPU 基础操作。不同芯片、开发板、模组和算力卡的固件、驱动和内存划分可能不同；已验证内容会在表格中标注，未补齐的产品保留待补充位置。
...
| 产品 / 形态 | 查询命令 | 当前状态 |
| --- | --- | --- |
| AX650N / AX8850N 主控开发板 | `cat /proc/ax_proc/version` | 已验证 |
| AX8850 / AX8850N 算力卡 | 待补充 | 需结合 AXCL 工具补充 |
| 终端计算智能视觉芯片开发板 / 模组 | 待补充 | 需按具体 SDK 补充 |
| 其他生态板卡 | 待补充 | 由板卡厂家补充 |

AX650N / AX8850N 主控开发板示例：
...
| --- | --- | --- | --- | --- |
| AX650N DEMO Board | AX650N / AX8850N | AX650_emmc_ubuntu_rootfs_desktop_V3.6.2_20250731140456_NO26076_sdk | 6 : 10 | 已验证 |
| M4N-Dock (爱芯派Pro) | AX8850 | AX650_pipro_box_ubuntu_rootfs_desktop_V3.6.2_20250603154858_NO4873_sdk.axp | 4 : 4 | 已验证 |
...
| 产品 / 形态 | 检查项 | 命令 | 说明 |
| --- | --- | --- | --- |
| AX650N / AX8850N 主控开发板 | DDR / AXI 带宽 | 待补充 | 记录读写带宽和测试条件 |
...
| 产品 / 形态 | OS:CMM | 说明 |
| --- | --- | --- |
| AX650N DEMO Board | 6 : 10 | OS 侧 6GB，CMM 侧 10GB |
...
| 产品 / 形态 | 查询方式 | 状态 |
| --- | --- | --- |
| AX650N / AX8850N 主控开发板 | 待补充 | 查询板端 NPU 资源 |
...
以下命令为 AX650N / AX8850N 相关主控开发板上的已验证示例。其他主控开发板可参考，但需要按对应 SDK 和系统版本调整。
